        ...
        while (1) {
            switch (_context.prev = _context.next) {
                case 0:
                    _context.prev = 0;
                    _context.next = 3;
                    return (0, _get.getAllPlayers)();

                case 3:
                    data = _context.sent;
                    playerTree = createPlayerTree(data.players);

                    (0, _render.renderElementTree)(playerTree, (0, _select2.default)('.container'));
                    _context.next = 11;
                    break;
                ...
                case 8:
                    ...
                    (0, _render.renderError)('Error', 'Unable to load players, please try again later', (0, _select2.default)('.container'));
...
function createPlayerTree(players) {
    ...
    players.forEach(function (_ref2) {
        var player = _ref2.player;

        tree.push({
            tagName: 'div',
            attributes: [{ key: 'class', value: 'col-lg-3 col-md-4 col-sm-6 col-xs-12' }],
            children: [{
                tagName: 'a',
                attributes: [{ key: 'class', value: 'player-tile__container' }, { key: 'href', value: './player?id=' + player.id }],
                children: [{
                    tagName: 'div',
                    attributes: [{ key: 'class', value: 'player-tile__image player-image--' + player.id }]
                }, {
                    tagName: 'div',
                    attributes: [{ key: 'class', value: 'player-tile__name' }],
                    children: [{
                        tagName: 'span',
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js?sourceMap!../../../node_modules/resolve-url-loader/index.js!../../../node_modules/sass-loader/lib/loader.js?sourceMap!./home.scss", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js?sourceMap!../../../node_modules/resolve-url-loader/index.js!../../../node_modules/sass-loader/lib/loader.js?sourceMap!./home.scss");
...
// module
exports.push([module.i, ".player-tile__container {\n  display: block;\n  margin: 0 auto 40px auto;\n  border-radius: 4px;\n  padding: 10px;\n  width: 240px;\n  border-left: 1px solid #c7c7c7;\n  border-right: 1px solid #c7c7c7;\n  border-top: 4px solid #3d00d2;\n  border-bottom: 4px solid #3d00d2;\n  text-decoration: none;\n  box-shadow: 0 3px 4px 0 rgba(0, 0, 0, 0.14), 0 1px 8px 0 rgba(0, 0, 0, 0.12), 0 3px 3px -2px rgba(0, 0, 0, 0.4);\n}\n\n.player-tile__container:hover {\n  box-shadow: 0 6px 10px 0 rgba(0, 0, 0, 0.14), 0 1px 18px 0 rgba(0, 0, 0, 0.12), 0 3px 5px -1px rgba(0, 0, 0, 0.4);\n}\n\n.player-tile__image:before {\n  content: '';\n  position: absolute;\n  width: 220px;\n  height: 280px;\n  background: linear-gradient(to bottom, transparent 0%, transparent 70%, white 100%);\n}\n\n.player-tile__name {\n  text-align: center;\n  font-size: 20px;\n  color: black;\n}\n\n", "", {"version":3,"sources":["/Users/rhonor/Projects/player-stats-card/src/pages/home/src/pages/home/src/pages/home/home.scss","/Users/rhonor/Projects/player-stats-card/src/pages/home/src/pages/home/src/style/shadow.scss","/Users/rhonor/Projects/player-stats-card/src/pages/home/home.scss"],"names":[],"mappings":"AAME;EACE,eAAA;EACA,yBAAA;EACA,mBAAA;EACA,cAAA;EACA,aAAA;EACA,+BAAA;EACA,gCAAA;EACA,8BAAA;EACA,iCAAA;EACA,sBAAA;ECDA,gHAAA;CCHH;;AFNC;ECqBE,kHAAA;CCXH;;AFSC;EAEI,YAAA;EACA,mBAAA;EACA,aAAA;EACA,cAAA;EACA,oFAAA;CEPL;;AFWC;EACE,mBAAA;EACA,gBAAA;EACA,aAAA;CERH","file":"home.scss","sourcesContent":["@import '../../style/shadow';\n\n$card-width: 220px;\n$card-height: 280px;\n\n.player-tile {\n  &__container {\n    display: block;\n    margin: 0 auto 40px auto;\n    border-radius: 4px;\n    padding: 10px;\n    width: $card-width + 20px;\n    border-left: 1px solid #c7c7c7;\n    border-right: 1px solid #c7c7c7;\n    border-top: 4px solid #3d00d2;\n    border-bottom: 4px solid #3d00d2;\n    text-decoration: none;\n\n    @include shadow(3);\n\n    &:hover {\n      @include shadow(6);\n    }\n  }\n\n  &__image {\n    &:before {\n      content: '';\n      position: absolute;\n      width: $card-width;\n      height: $card-height;\n      background: linear-gradient(to bottom, rgba(0,0,0,0) 0%, rgba(0,0,0,0) 70%, rgba(255,255,255,1) 100%);\n    }\n  }\n\n  &__name {\n    text-align: center;\n    font-size: 20px;\n    color: black;\n  }\n}\n","@mixin z-depth-transition() {\n    transition: box-shadow .28s cubic-bezier(.4, 0, .2, 1);\n}\n\n@mixin z-depth-focus() {\n    box-shadow: 0 0 8px rgba(0, 0, 0, .18), 0 8px 16px rgba(0, 0, 0, .36);\n}\n\n@mixin z-depth-2dp() {\n    box-shadow: 0 2px 2px 0 rgba(0, 0, 0, .14),\n    0 1px 5px 0 rgba(0, 0, 0, .12),\n    0 3px 1px -2px rgba(0, 0, 0, .2);\n}\n\n@mixin z-depth-3dp() {\n    box-shadow: 0 3px 4px 0 rgba(0, 0, 0, .14),\n    0 1px 8px 0 rgba(0, 0, 0, .12),\n    0 3px 3px -2px rgba(0, 0, 0, .4);\n}\n\n@mixin z-depth-4dp() {\n    box-shadow: 0 4px 5px 0 rgba(0, 0, 0, .14),\n    0 1px 10px 0 rgba(0, 0, 0, .12),\n    0 2px 4px -1px rgba(0, 0, 0, .4);\n}\n\n@mixin z-depth-6dp() {\n    box-shadow: 0 6px 10px 0 rgba(0, 0, 0, .14),\n    0 1px 18px 0 rgba(0, 0, 0, .12),\n    0 3px 5px -1px rgba(0, 0, 0, .4);\n}\n\n@mixin z-depth-8dp() {\n    box-shadow: 0 8px 10px 1px rgba(0, 0, 0, .14),\n    0 3px 14px 2px rgba(0, 0, 0, .12),\n    0 5px 5px -3px rgba(0, 0, 0, .4);\n}\n\n@mixin z-depth-16dp() {\n    box-shadow: 0 16px 24px 2px rgba(0, 0, 0, .14),\n    0  6px 30px 5px rgba(0, 0, 0, .12),\n    0  8px 10px -5px rgba(0, 0, 0, .4);\n}\n\n@mixin z-depth-24dp() {\n    box-shadow: 0  9px 46px  8px rgba(0, 0, 0, .14),\n    0 24px 38px  3px rgba(0, 0, 0, .12),\n    0 11px 15px -7px rgba(0, 0, 0, .4);\n}\n\n@mixin shadow($dp: 2) {\n    @if $dp == 2 {\n        @include z-depth-2dp();\n    } @else if $dp == 3 {\n        @include z-depth-3dp();\n    } @else if $dp == 4 {\n        @include z-depth-4dp();\n    } @else if $dp == 6 {\n        @include z-depth-6dp();\n    } @else if $dp == 8 {\n        @include z-depth-8dp();\n    } @else if $dp == 16 {\n        @include z-depth-16dp();\n    } @else if $dp == 24 {\n        @include z-depth-24dp();\n    }\n}\n",".player-tile__container {\n  display: block;\n  margin: 0 auto 40px auto;\n  border-radius: 4px;\n  padding: 10px;\n  width: 240px;\n  border-left: 1px solid #c7c7c7;\n  border-right: 1px solid #c7c7c7;\n  border-top: 4px solid #3d00d2;\n  border-bottom: 4px solid #3d00d2;\n  text-decoration: none;\n  box-shadow: 0 3px 4px 0 rgba(0, 0, 0, 0.14), 0 1px 8px 0 rgba(0, 0, 0, 0.12), 0 3px 3px -2px rgba(0, 0, 0, 0.4);\n}\n\n.player-tile__container:hover {\n  box-shadow: 0 6px 10px 0 rgba(0, 0, 0, 0.14), 0 1px 18px 0 rgba(0, 0, 0, 0.12), 0 3px 5px -1px rgba(0, 0, 0, 0.4);\n}\n\n.player-tile__image:before {\n  content: '';\n  position: absolute;\n  width: 220px;\n  height: 280px;\n  background: linear-gradient(to bottom, transparent 0%, transparent 70%, white 100%);\n}\n\n.player-tile__name {\n  text-align: center;\n  font-size: 20px;\n  color: black;\n}\n\n"],"sourceRoot":""}]);
