...
exports.getPlayerById = exports.getAllPlayers = undefined;
...
var getAllPlayers = exports.getAllPlayers = function () {
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        _context.next = 2;
                        return getEndpoint(PLAYER_DATA_URL, defaultOptions);
    ...
    return function getAllPlayers() {
        return _ref.apply(this, arguments);
    };
}();

var getPlayerById = exports.getPlayerById = function () {
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
            while (1) {
                switch (_context2.prev = _context2.next) {
                    case 0:
                        endpoint = PLAYER_DATA_URL + '?id=' + id;
                        _context2.next = 3;
                        return getEndpoint(endpoint, defaultOptions);
    ...
    return function getPlayerById(_x2) {
...
var PLAYER_DATA_URL = 'https://wqipgayic2.execute-api.eu-west-1.amazonaws.com/prod/players';
...
exports.renderElementTree = renderElementTree;
...
function createElement(tagName) {
    var parentNode = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : (0, _select2.default)('body');
...
function renderElementTree() {
    ...
    tree.forEach(function (node) {
        var newNode = createElement(node.tagName, parentNode, node.attributes, node.text);
...
function renderTable() {
    var table = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { body: [[]] };
    var parentNode = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : (0, _select2.default)('body');
    ...
    if (table.headers) {
        tree[0].children.push({
            ...
            children: [{
                tagName: 'tr',
                children: table.headers.map(function (heading) {
                    return {
                        tagName: 'th',
                        text: heading
                    };
    ...
    tree[0].children.push({
        tagName: 'tbody',
        children: table.body.map(function (row) {
            return {
                tagName: 'tr',
...
function renderError(header, text, parentNode) {
    var error = [{
        tagName: 'div',
        attributes: [{ key: 'class', value: 'error' }],
        children: [{
            tagName: 'h3',
            text: header,
            attributes: [{ key: 'class', value: 'error__header' }]
        }, {
            tagName: 'p',
            text: text,
            attributes: [{ key: 'class', value: 'error__text' }]
        }]
    }];
...
var _get = __webpack_require__(331);

var _render = __webpack_require__(333);

var _select = __webpack_require__(124);

var _select2 = _interopRequireDefault(_select);

var _getParams = __webpack_require__(338);
...
_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var data, playerInfo, playerStats;
    return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
            switch (_context.prev = _context.next) {
                case 0:
                    _context.prev = 0;
                    _context.next = 3;
                    return (0, _get.getPlayerById)((0, _getParams2.default)().id || -1);
                ...
                case 3:
                    ...
                    playerInfo = createPlayerInfoTable(data.player);
                    playerStats = createPlayerStatsTable(data.stats);


                    (0, _render.renderTable)(playerInfo, (0, _select2.default)('.player-info-table'));
                    (0, _render.renderTable)(playerStats, (0, _select2.default)('.player-stats-table'));
                    _context.next = 14;
                    break;
                ...
                case 11:
                    ...
                    (0, _render.renderError)('Error', 'Unable to load player, please try again later', (0, _select2.default)('.container'));

                case 14:

                    (0, _select2.default)('.loader').style.display = 'none';
...
function renderPlayerBanner(player) {
    var tree = [{
        tagName: 'div',
        attributes: [{ key: 'class', value: 'player-banner__portrait-container col-sm-3 col-xs-12' }],
        children: [{
            tagName: 'div',
            attributes: [{ key: 'class', value: 'player-banner__portrait player-image--' + player.id }]
        }]
    }, {
        tagName: 'div',
        attributes: [{ key: 'class', value: 'player-banner__info col-sm-6 col-xs-8' }],
        children: [{
            tagName: 'h2',
            text: player.name.first + ' ' + player.name.last,
            attributes: [{ key: 'class', value: 'player-banner__name' }]
        }, {
            tagName: 'p',
            text: player.info.shirtNum,
            attributes: [{ key: 'class', value: 'player-banner__number' }]
        }]
    }, {
        tagName: 'div',
        attributes: [{ key: 'class', value: 'player-banner__club col-sm-2 col-xs-4' }],
        children: [{
            tagName: 'div',
            attributes: [{ key: 'class', value: 'team-icon--' + player.currentTeam.id }]
        }]
    }];

    (0, _render.renderElementTree)(tree, (0, _select2.default)('.player-banner'));
}

function createPlayerInfoTable(player) {
    return {
        headers: ['About'],
        body: [['Age', player.age], ['Nationality', player.nationalTeam.demonym], ['Team', player.currentTeam.name], ['Position', player.info.positionInfo], ['First team', player.currentTeam.teamType === 'FIRST' ? 'Yes' : 'No']]
    };
}

function createPlayerStatsTable(stats) {
    var getStat = function getStat(statName) {
        return stats.filter(function (el) {
    ...
    return {
        headers: ['Stats'],
        body: [['Goals', getStat('goals')], ['Apperances', getStat('appearances')], ['Wins', getStat('wins')], ['Losses', getStat('losses')], ['Draws', getStat('draws')], ['Forward passes', getStat('fwd_pass')], ['Backward passes', getStat('goals')], ['Assists', getStat('goal_assist')], ['Mins player', getStat('mins_played')]]
    };
}
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js?sourceMap!../../../node_modules/resolve-url-loader/index.js!../../../node_modules/sass-loader/lib/loader.js?sourceMap!./players.scss", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js?sourceMap!../../../node_modules/resolve-url-loader/index.js!../../../node_modules/sass-loader/lib/loader.js?sourceMap!./players.scss");
...
// module
exports.push([module.i, ".player-banner__portrait {\n  margin: 20px auto 30px auto;\n}\n\n@media (min-width: 768px) {\n  .player-banner__info,\n  .player-banner__club {\n    margin-top: 40px;\n  }\n}\n\n.player-banner__name,\n.player-banner__number {\n  margin: 0 auto 0 0;\n  text-align: left;\n}\n\n.player-banner__name {\n  font-size: 28px;\n}\n\n.player-banner__number {\n  font-size: 40px;\n}\n\n.player-info-table table,\n.player-stats-table table {\n  max-width: 450px;\n  width: 95%;\n  margin: 20px auto;\n  border-left: 1px solid #c7c7c7;\n  border-right: 1px solid #c7c7c7;\n  border-top: 4px solid #3d00d2;\n  border-bottom: 4px solid #3d00d2;\n  border-radius: 4px;\n  box-shadow: 0 3px 4px 0 rgba(0, 0, 0, 0.14), 0 1px 8px 0 rgba(0, 0, 0, 0.12), 0 3px 3px -2px rgba(0, 0, 0, 0.4);\n}\n\n.player-info-table table th,\n.player-stats-table table th {\n  text-align: left;\n  padding: 5px;\n  font-size: 20px;\n}\n\n.player-info-table table td,\n.player-stats-table table td {\n  padding: 5px;\n  font-size: 16px;\n}\n\n.player-info-table table td:nth-child(2),\n.player-stats-table table td:nth-child(2) {\n  text-align: right;\n}\n\n", "", {"version":3,"sources":["/Users/rhonor/Projects/player-stats-card/src/pages/player/src/pages/player/src/pages/player/players.scss","/Users/rhonor/Projects/player-stats-card/src/pages/player/players.scss","/Users/rhonor/Projects/player-stats-card/src/pages/player/src/pages/player/src/style/shadow.scss"],"names":[],"mappings":"AAGI;EACI,4BAAA;CCFP;;ADKG;EACI;;IACI,iBAAA;GCDT;CACF;;ADGG;;EACI,mBAAA;EACA,iBAAA;CCCP;;ADEG;EACI,gBAAA;CCCP;;ADEG;EACI,gBAAA;CCCP;;ADGD;;EAEQ,iBAAA;EACA,WAAA;EACA,kBAAA;EACA,+BAAA;EACA,gCAAA;EACA,8BAAA;EACA,iCAAA;EACA,mBAAA;EEpBJ,gHAAA;CDqBH;;ADVD;;EAcY,iBAAA;EACA,aAAA;EACA,gBAAA;CCCX;;ADjBD;;EAoBY,aAAA;EACA,gBAAA;CCEX;;ADvBD;;EAwBgB,kBAAA;CCIf","file":"players.scss","sourcesContent":["@import '../../style/shadow';\n\n.player-banner {\n    &__portrait {\n        margin: 20px auto 30px auto;\n    }\n\n    @media (min-width: 768px) {\n        &__info, &__club {\n            margin-top: 40px;\n        }\n    }\n    &__name, &__number {\n        margin: 0 auto 0 0;\n        text-align: left;\n    }\n\n    &__name {\n        font-size: 28px;\n    }\n\n    &__number {\n        font-size: 40px;\n    }\n}\n\n.player-info-table, .player-stats-table {\n    table {\n        max-width: 450px;\n        width: 95%;\n        margin: 20px auto;\n        border-left: 1px solid #c7c7c7;\n        border-right: 1px solid #c7c7c7;\n        border-top: 4px solid #3d00d2;\n        border-bottom: 4px solid #3d00d2;\n        border-radius: 4px;\n\n        @include shadow(3);\n\n        th {\n            text-align: left;\n            padding: 5px;\n            font-size: 20px;\n        }\n\n        td {\n            padding: 5px;\n            font-size: 16px;\n\n            &:nth-child(2) {\n                text-align: right;\n            }\n        }\n    }\n}\n",".player-banner__portrait {\n  margin: 20px auto 30px auto;\n}\n\n@media (min-width: 768px) {\n  .player-banner__info,\n  .player-banner__club {\n    margin-top: 40px;\n  }\n}\n\n.player-banner__name,\n.player-banner__number {\n  margin: 0 auto 0 0;\n  text-align: left;\n}\n\n.player-banner__name {\n  font-size: 28px;\n}\n\n.player-banner__number {\n  font-size: 40px;\n}\n\n.player-info-table table,\n.player-stats-table table {\n  max-width: 450px;\n  width: 95%;\n  margin: 20px auto;\n  border-left: 1px solid #c7c7c7;\n  border-right: 1px solid #c7c7c7;\n  border-top: 4px solid #3d00d2;\n  border-bottom: 4px solid #3d00d2;\n  border-radius: 4px;\n  box-shadow: 0 3px 4px 0 rgba(0, 0, 0, 0.14), 0 1px 8px 0 rgba(0, 0, 0, 0.12), 0 3px 3px -2px rgba(0, 0, 0, 0.4);\n}\n\n.player-info-table table th,\n.player-stats-table table th {\n  text-align: left;\n  padding: 5px;\n  font-size: 20px;\n}\n\n.player-info-table table td,\n.player-stats-table table td {\n  padding: 5px;\n  font-size: 16px;\n}\n\n.player-info-table table td:nth-child(2),\n.player-stats-table table td:nth-child(2) {\n  text-align: right;\n}\n\n","@mixin z-depth-transition() {\n    transition: box-shadow .28s cubic-bezier(.4, 0, .2, 1);\n}\n\n@mixin z-depth-focus() {\n    box-shadow: 0 0 8px rgba(0, 0, 0, .18), 0 8px 16px rgba(0, 0, 0, .36);\n}\n\n@mixin z-depth-2dp() {\n    box-shadow: 0 2px 2px 0 rgba(0, 0, 0, .14),\n    0 1px 5px 0 rgba(0, 0, 0, .12),\n    0 3px 1px -2px rgba(0, 0, 0, .2);\n}\n\n@mixin z-depth-3dp() {\n    box-shadow: 0 3px 4px 0 rgba(0, 0, 0, .14),\n    0 1px 8px 0 rgba(0, 0, 0, .12),\n    0 3px 3px -2px rgba(0, 0, 0, .4);\n}\n\n@mixin z-depth-4dp() {\n    box-shadow: 0 4px 5px 0 rgba(0, 0, 0, .14),\n    0 1px 10px 0 rgba(0, 0, 0, .12),\n    0 2px 4px -1px rgba(0, 0, 0, .4);\n}\n\n@mixin z-depth-6dp() {\n    box-shadow: 0 6px 10px 0 rgba(0, 0, 0, .14),\n    0 1px 18px 0 rgba(0, 0, 0, .12),\n    0 3px 5px -1px rgba(0, 0, 0, .4);\n}\n\n@mixin z-depth-8dp() {\n    box-shadow: 0 8px 10px 1px rgba(0, 0, 0, .14),\n    0 3px 14px 2px rgba(0, 0, 0, .12),\n    0 5px 5px -3px rgba(0, 0, 0, .4);\n}\n\n@mixin z-depth-16dp() {\n    box-shadow: 0 16px 24px 2px rgba(0, 0, 0, .14),\n    0  6px 30px 5px rgba(0, 0, 0, .12),\n    0  8px 10px -5px rgba(0, 0, 0, .4);\n}\n\n@mixin z-depth-24dp() {\n    box-shadow: 0  9px 46px  8px rgba(0, 0, 0, .14),\n    0 24px 38px  3px rgba(0, 0, 0, .12),\n    0 11px 15px -7px rgba(0, 0, 0, .4);\n}\n\n@mixin shadow($dp: 2) {\n    @if $dp == 2 {\n        @include z-depth-2dp();\n    } @else if $dp == 3 {\n        @include z-depth-3dp();\n    } @else if $dp == 4 {\n        @include z-depth-4dp();\n    } @else if $dp == 6 {\n        @include z-depth-6dp();\n    } @else if $dp == 8 {\n        @include z-depth-8dp();\n    } @else if $dp == 16 {\n        @include z-depth-16dp();\n    } @else if $dp == 24 {\n        @include z-depth-24dp();\n    }\n}\n"],"sourceRoot":""}]);
